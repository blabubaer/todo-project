    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'todoapp/signupuser.html', {'form':UserCreationForm(), 'error':'Username already in use!'})
...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todoapp/createtodo.html', {'form':TodoForm(), 'error':'Bad Data paste in. Try again.' })
